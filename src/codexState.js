...
// Для експорту назовні, щоб інші модулі не відтворювали ключі
...
// -------------------- службові ключі для інших модулів --------------------
export function getIdeaDraftKey(userId) {
  return IDEA_DRAFT_KEY_INTERNAL(userId);
}

export function getUiAwaitKey(userId) {
  return UI_AWAIT_KEY_INTERNAL(userId);
}
